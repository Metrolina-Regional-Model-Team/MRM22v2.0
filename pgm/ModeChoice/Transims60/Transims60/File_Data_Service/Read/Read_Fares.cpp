...
void Data_Service::Initialize_Fares (Fare_File &file)
{
	if (file.Header_Record ().empty ()) {
		...
		file.Header_Record (text);
		file.Update_Def_Header ();
	} else {

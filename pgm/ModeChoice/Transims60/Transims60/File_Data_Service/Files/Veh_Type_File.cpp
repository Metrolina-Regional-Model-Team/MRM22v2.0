...
void Veh_Type_File::Setup (void)
{
	...
	type = length = max_speed = max_accel = max_decel = op_cost = use = capacity = max_load = load_func = -1;
...
bool Veh_Type_File::Create_Fields (void) 
{
	...
	Add_Field ("LOAD_FUNC", DB_INTEGER, 3);
...
bool Veh_Type_File::Set_Field_Numbers (void)
{
	...
	load_func = Optional_Field ("LOAD_FUNC", "TRANSIT_FUNC", "LOAD_FUNCTION", "MAX_FUNC");

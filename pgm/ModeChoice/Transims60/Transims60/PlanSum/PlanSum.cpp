...
PlanSum::PlanSum (void) : Data_Service (), Select_Service (), Flow_Time_Service ()
{
	...
	System_File_Type optional_files [] = {
		...
		SELECTION, VEHICLE_TYPE, PERFORMANCE, RIDERSHIP, TURN_DELAY, NEW_PERFORMANCE, NEW_TURN_DELAY, 
		NEW_RIDERSHIP, NEW_PARK_DEMAND, END_FILE
	};
	...
	int data_service_keys [] = {
		DAILY_WRAP_FLAG, SUMMARY_TIME_RANGES, SUMMARY_TIME_INCREMENT, PERIOD_CONTROL_POINT, PARKING_DEMAND_TYPE, PARKING_PENALTY_FUNCTION, 0
	};
	int select_service_keys [] = {
		...
		SELECT_ORIGIN_ZONES, SELECT_DESTINATION_ZONES, 
	...
	Control_Key keys [] = { //--- code, key, level, status, type, default, range, help ----
		...
		{ NEW_STOP_TRANSFER_FILE, "NEW_STOP_TRANSFER_FILE", LEVEL0, OPT_KEY, OUT_KEY, "", FILE_RANGE, NO_HELP },
		{ NEW_STOP_TRANSFER_FORMAT, "NEW_STOP_TRANSFER_FORMAT", LEVEL0, OPT_KEY, TEXT_KEY, "TAB_DELIMITED", FORMAT_RANGE, FORMAT_HELP },
		{ NEW_PLAN_SKIM_FILE, "NEW_PLAN_SKIM_FILE", LEVEL0, OPT_KEY, OUT_KEY, "", PARTITION_RANGE, NO_HELP },
		{ NEW_PLAN_SKIM_FORMAT, "NEW_PLAN_SKIM_FORMAT", LEVEL0, OPT_KEY, TEXT_KEY, "TAB_DELIMITED", FORMAT_RANGE, FORMAT_HELP },
		{ NEW_PLAN_STOP_FILE, "NEW_PLAN_STOP_FILE", LEVEL0, OPT_KEY, OUT_KEY, "", FILE_RANGE, NO_HELP },
		{ NEW_PLAN_STOP_FORMAT, "NEW_PLAN_STOP_FORMAT", LEVEL0, OPT_KEY, TEXT_KEY, "TAB_DELIMITED", FORMAT_RANGE, FORMAT_HELP },
		END_CONTROL
	};
	const char *reports [] = {
		"TOP_100_V/C_RATIOS",
	...
	access_group_flag = plan_skim_flag = stop_transfer_flag = plan_stop_flag = false;
	cap_factor = 0.25;
	minimum_vc = 1.0;

...
TransitNet::TransitNet (void) : Data_Service (), Select_Service ()
{
	...
	Control_Key transimsnet_keys [] = { //--- code, key, level, status, type, default, range, help ----
		...
		{ ADD_ROUTE_STOPS_FILE, "ADD_ROUTE_STOPS_FILE", LEVEL0, OPT_KEY, IN_KEY, "", FILE_RANGE, NO_HELP },
		{ ADD_ROUTE_STOPS_FORMAT, "ADD_ROUTE_STOPS_FORMAT", LEVEL0, OPT_KEY, TEXT_KEY, "TAB_DELIMITED", FORMAT_RANGE, FORMAT_HELP },
	...
	delete_transit_modes = delete_stop_flag = delete_route_flag = zone_stop_flag = add_stops_flag = false;
	...
	route_data_field = route_join_field = stop_field = zone_field = zone_fld = stop_fld = add_route_field = add_stop_field = add_fare_field = add_index_field = -1;

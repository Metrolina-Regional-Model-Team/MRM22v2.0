...
//char * TripSum::SELECT_PROBABILITY_FORMAT	= "SELECT_PROBABILITY_FORMAT";
	...
	Control_Key keys [] = { //--- code, key, level, status, type, default, range, help ----
		...
		{ NEW_MODE_PURPOSE_GROUP_FILE, "NEW_MODE_PURPOSE_GROUP_FILE", LEVEL0, OPT_KEY, OUT_KEY, "", FILE_RANGE, NO_HELP },
		{ NEW_MODE_PURPOSE_GROUP_FORMAT, "NEW_MODE_PURPOSE_GROUP_FORMAT", LEVEL0, OPT_KEY, TEXT_KEY, "TAB_DELIMITED", FORMAT_RANGE, NO_HELP },
		{ NEW_LOCATION_SHARE_FILE, "NEW_LOCATION_SHARE_FILE", LEVEL0, OPT_KEY, OUT_KEY, "", FILE_RANGE, NO_HELP },
		{ NEW_LOCATION_SHARE_FORMAT, "NEW_LOCATION_SHARE_FORMAT", LEVEL0, OPT_KEY, TEXT_KEY, "TAB_DELIMITED", FORMAT_RANGE, NO_HELP },
	...
	group_report_flag = group_file_flag = false;

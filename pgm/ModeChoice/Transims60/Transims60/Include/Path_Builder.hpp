...
public:
	...
	void Update_Rider_Penalties (void);	

	void Save_Park_Demand (void);
	void Update_Park_Penalties (void);
...
private:
	...
	bool transfer_flag, reset_veh_flag, mode_path_flag [MAX_MODE], flow_flag, walk_acc_flag, park_flag, park_cap_flag;
	...
	bool initialized, forward_flag, plan_flag, trip_flag, reroute_flag;
	...
	Line_Array *line_array_ptr;
	Park_Demand_Array *park_demand_array_ptr;
	...
	bool Transfer_Fare (Path_Ptr path_ptr, int &mode, int &on_zone, int &off_zone, int &fare);

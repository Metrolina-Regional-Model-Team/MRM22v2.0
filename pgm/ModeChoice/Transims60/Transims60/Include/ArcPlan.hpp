...
protected:
	enum ArcPlan_Keys { 
		...
		NEW_ARC_LOCATION_DEMAND_FILE, NEW_ARC_DRIVE_ACCESS_FILE, CONTOUR_TIME_INCREMENTS, CONTOUR_DISTANCE_INCREMENTS, RIDERSHIP_SCALING_FACTOR, 
		MINIMUM_RIDERSHIP_VALUE, MINIMUM_RIDERSHIP_SIZE, MAXIMUM_RIDERSHIP_SIZE, PROBLEM_DISPLAY_METHOD, DRIVE_ACCESS_DISPLAY_METHOD
	};
...
private:
	...
	Arcview_File arcview_plan, arcview_problem, arcview_access, arcview_drive_access;
	Arcview_File arcview_width, arcview_time, arcview_distance;
	Arcview_File arcview_rider, arcview_stop, arcview_group, arcview_parking, arcview_location;
	...
	int num_out, num_problem, max_problem, num_width, num_time, num_distance, num_access, num_drive_access;
	int num_rider, num_stop, num_group, min_load, num_parking, num_location, problem_method, drive_parking, drive_method;

	Integers load_data, board_data, alight_data, stop_list, parking_out, parking_in, productions, attractions;
	Doubles width_data;
	Bools link_flag;

	double load_factor, min_rider, max_rider, random_share;

	bool route_flag, driver_flag, stop_flag, type_flag, problem_flag, problem_out, plan_flag, plan_skim_flag;
	bool path_flag, hhlist_flag, width_flag, time_flag, distance_flag, turn_flag, drive_access_flag;
	bool access_flag, rider_flag, load_flag, on_off_flag, demand_flag, group_flag, parking_flag, location_flag;

...
public:
	...
	static Park_Demand_Type Park_Demand_Code (String text)       { return ((Park_Demand_Type) Type_Code (text, park_demand_codes, "Parking Demand")); }
	static const char * Park_Demand_Code (Park_Demand_Type code) { return (Type_Code (code, park_demand_codes)); }
...
private:
	...
	static Code_Text park_demand_codes [];

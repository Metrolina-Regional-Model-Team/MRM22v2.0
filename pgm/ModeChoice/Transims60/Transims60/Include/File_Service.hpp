...
public:
	...
	enum File_Service_Keys { 
		...
		TRIP_SORT_TYPE, PLAN_SORT_TYPE, SKIM_OD_UNITS, SKIM_TIME_PERIODS, SKIM_TIME_INCREMENT, SKIM_TOTAL_TIME_FLAG,
	...
	Park_Demand_File * System_Park_Demand_File (bool new_flag = false)  { return ((Park_Demand_File *) System_File_Handle ((new_flag) ? NEW_PARK_DEMAND : PARK_DEMAND)); }
	Plan_Skim_File *   System_Plan_Skim_File (bool new_flag = false)    { return ((Plan_Skim_File *) System_File_Handle ((new_flag) ? NEW_PLAN_SKIM : PLAN_SKIM)); }
...
private:
	...
	bool lane_use_flows, trip_sort_flag, time_sort_flag;

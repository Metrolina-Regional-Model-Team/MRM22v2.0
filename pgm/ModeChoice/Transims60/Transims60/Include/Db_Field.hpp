...
public:
	...
	void  Width (int value)                { width = (short) value;	}
	void  Decimal (int value)              { decimal = (short) value; }
	...
	void  Clear (void)                     { name.clear (); buffer.clear (); nest = NO_NEST; offset = 0; width = decimal = 0; units = NO_UNITS; }

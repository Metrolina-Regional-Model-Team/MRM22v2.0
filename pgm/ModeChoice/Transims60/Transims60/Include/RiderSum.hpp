...
private:
	...
	Db_File stop_profile, stop_vehtype_file, stop_lines, stop_detail_file, load_summary_file;
	bool rider_flag, on_off_flag, line_rider_flag, line_group_flag, stop_route_flag, stop_group_flag;
	bool stop_profile_flag, stop_vehtype_flag, stop_lines_flag, stop_detail_flag, load_summary_flag, link_load_flag;
	...
	void Write_Load_Summary (void);
	void Write_Link_Loads (void);

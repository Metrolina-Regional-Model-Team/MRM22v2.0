...
public:
	...
	int    Load_Func (void)           { return (Get_Integer (load_func)); }
	...
	void   Load_Func (int value)      { Put_Field (load_func, value); }
...
private:
	...
	int type, length, max_speed, max_accel, max_decel, op_cost, use, capacity, max_load, load_func;

...
User_Program::Token_Data  User_Program::specials [] = {
		...
		{"RTAB9",   TABLE,      RTAB + 90   },
		{"STAB9",   TABLE,      STAB + 90   },
		{ "ITAB10", TABLE,      ITAB + 100  },
		{ "RTAB10", TABLE,      RTAB + 100  },
		{ "STAB10", TABLE,      STAB + 100  },
		{ "ITAB11", TABLE,      ITAB + 110  },
		{ "RTAB11", TABLE,      RTAB + 110  },
		{ "STAB11", TABLE,      STAB + 110  },
		{ "ITAB12", TABLE,      ITAB + 120  },
		{ "RTAB12", TABLE,      RTAB + 120  },
		{ "STAB12", TABLE,      STAB + 120  },
		{ "ITAB13", TABLE,      ITAB + 130  },
		{ "RTAB13", TABLE,      RTAB + 130  },
		{ "STAB13", TABLE,      STAB + 130  },
		{ "ITAB14", TABLE,      ITAB + 140  },
		{ "RTAB14", TABLE,      RTAB + 140  },
		{ "STAB14", TABLE,      STAB + 140  },
		{ "ITAB15", TABLE,      ITAB + 150  },
		{ "RTAB15", TABLE,      RTAB + 150  },
		{ "STAB15", TABLE,      STAB + 150  },
		{ "ITAB16", TABLE,      ITAB + 160  },
		{ "RTAB16", TABLE,      RTAB + 160  },
		{ "STAB16", TABLE,      STAB + 160  },
		{ "ITAB17", TABLE,      ITAB + 170  },
		{ "RTAB17", TABLE,      RTAB + 170  },
		{ "STAB17", TABLE,      STAB + 170  },
		{ "ITAB18", TABLE,      ITAB + 180  },
		{ "RTAB18", TABLE,      RTAB + 180  },
		{ "STAB18", TABLE,      STAB + 180  },
		{ "ITAB19", TABLE,      ITAB + 190  },
		{ "RTAB19", TABLE,      RTAB + 190  },
		{ "STAB19", TABLE,      STAB + 190  },
		{"IR_MAP",  MAP,        IR_MAP      },
		{"IS_MAP",  MAP,        IS_MAP      },
		{"SI_MAP",  MAP,        SI_MAP      },
		{"IR_MAP0", MAP,        IR_MAP      },

...
Static_Service::Code_Text  Static_Service::units_codes [] = {
	...
	{ CONNECT_CODE, "CONNECTION_TYPE" }, { PARKING_CODE, "PARKING_TYPE" }, { PARK_DEMAND_CODE, "PARK_DEMAND_TYPE" },
...
Static_Service::Code_Text Static_Service::parking_codes [] = {
	...
	{ BUS_PNR, "BUS_PNR" }, { RAIL_PNR, "RAIL_PNR" }, { MAJOR_PNR, "MAJOR_PNR" },
	{ STREET, "PRSTR" }, { STREET, "HISTR" }, { LOT, "DRVWY" }, { BOUNDARY, "BNDRY" },
	{ PARKRIDE,"PARKR" }, { BUS_PNR, "BUS" }, { RAIL_PNR, "RAIL" }, { MAJOR_PNR, "MAJOR" },
	{ 0, 0 }
};

//---- parking demand codes ----

Static_Service::Code_Text Static_Service::park_demand_codes [] = {
	{ ALL_LOTS, "ALL" }, { CAP_LOTS, "CAPACITY", }, { PNR_LOTS, "PARKRIDE" }, { RAIL_LOTS, "RAIL_PNR" },
	{ ALL_LOTS, "ALL_LOTS" }, { CAP_LOTS, "CAP_LOTS", }, { PNR_LOTS, "PNR_LOTS" }, { RAIL_LOTS, "RAIL_LOTS" },
	{ 0, 0 }
};
...
Static_Service::Code_Text Static_Service::stop_codes [] = {
	{ NO_STOP, "NO_STOP" }, { STOP, "STOP" }, { STATION, "STATION" }, { PNR_STOP, "PNR_STOP" }, 
	{ EXTLOAD, "EXTERNAL" }, { NEARSIDE, "NEARSIDE" }, { FARSIDE, "FARSIDE" }, { MIDBLOCK, "MIDBLOCK" }, 
	{ ON_ONLY, "ON_ONLY"}, { OFF_ONLY, "OFF_ONLY" }, { ON_ONLY, "BOARD" }, { OFF_ONLY, "ALIGHT" }, 
	{ NO_STOP, "" }, { NO_STOP, "NON_STOP" }, { NO_STOP, "NO" }, { PNR_STOP, "PNR" }, { PNR_STOP, "PARKRIDE" }, 
	{ 0, 0 }
};
...
Static_Service::Code_Text  Static_Service::use_codes [] = {
	{ ANY, "ANY" }, { WALK, "WALK" }, { BIKE, "BIKE" }, { CAR, "CAR" }, { HOV2P, "HOV2+" }, { HOV3P, "HOV3+" }, 
	{ TRUCK, "TRUCK" }, { BUS, "BUS" }, { RAIL, "RAIL" }, { SOV, "SOV" }, { HOV2, "HOV2" }, { HOV3, "HOV3" }, 
	{ HOV4, "HOV4" }, { LIGHTTRUCK, "LIGHTTRUCK" }, { HEAVYTRUCK, "HEAVYTRUCK" }, { TAXI, "TAXI" }, 
	{ RESTRICTED, "RESTRICTED" }, { NONE, "NONE" }, { CAR, "AUTO" }, { HOV4, "HOV4+" }, { BIKE, "BICYCLE" }, 
	{ BUS, "LOCAL"}, { BUS, "EXPRESS" }, { BUS, "LOCAL_BUS" }, { BUS, "EXPRESS_BUS" }, { BUS, "BRT" }, 
	{ BUS, "TROLLEY" }, { RAIL, "STREETCAR" }, { RAIL, "LIGHTRAIL" }, { RAIL, "LRT" }, { RAIL, "RAPIDRAIL" }, 
	{ RAIL, "METRORAIL"}, { RAIL, "REGIONRAIL" }, { RAIL, "AMTRAK" }, 
	{ 0, 0 }
};
//---- system file codes ----
...
Static_Service::Code_Text  Static_Service::problem_codes [] = {
	...
	{ FUEL_PROBLEM, "Fuel Supply" }, { PARK_CAP_PROBLEM, "Parking Capacity" }, { 0, 0 }
};
...
Use_Type Static_Service::transit_use_map [] = {
	ANY, BUS, BUS, BUS, RAIL, RAIL, RAIL, RAIL, BUS, ANY
}; 
...
int Static_Service::Internal_Units (string &text, Units_Type units) 
{
	...
	switch (units) {
		...
		case PARKING_CODE:
			...
			break;
		case PARK_DEMAND_CODE:
			code = Park_Demand_Code (text);
			break;
		case STOP_CODE:
			code = Stop_Code (text);
			break;
...
void Static_Service::External_Units (int code, Units_Type units, String &result) 
{
	switch (units) {
		...
		case PARKING_CODE:
			...
			break;
		case PARK_DEMAND_CODE:
			result = Park_Demand_Code ((Park_Demand_Type) code);
			break;
		case STOP_CODE:

...
protected:
	enum ModeChoice_Keys { 
		PLAN_FILE = 1, PLAN_FORMAT, PLAN_SKIM_FILE, PLAN_SKIM_FORMAT, TOUR_MODE_CHOICE, APPLY_AUTO_OCCUPANCY,
...
private:
	...
	bool memory_flag, new_plan_flag, rider_flag, park_demand_flag, penalty_update_flag, auto_occ_flag;
	...
	Doubles nest_levels, nest_coef, veh_type_buckets;
	...
	Plan_Skim_File_Array plan_skims, plan_skim_files, index_skims;

...
public:
	...
	XY_Range Coordinate_Extent (void)       { return (shape_header.box); }

	void Coordinate_Extent (double &xmin, double &ymin, double &xmax, double &ymax)
	                                        { xmin = shape_header.box.xmin; ymin = shape_header.box.ymin;
	                                          xmax = shape_header.box.xmax; ymax = shape_header.box.ymax; }

	XY_Range Coordinate_Range (void)        { return (range); }

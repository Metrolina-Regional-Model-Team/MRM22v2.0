...
typedef struct {
	...
	int       num_parkride;                  //---- maximum number of park ride options ----
	int       max_bus_pnr;                   //---- maximum percentage of total trip time as auto driver ----
	int       num_bus_pnr;                   //---- maximum number of bus park ride options --
	int       max_rail_pnr;                  //---- maximum percentage of total trip time as auto driver ----
	int       num_rail_pnr;                  //---- maximum number of rail park ride options --
	int       max_major_pnr;                 //---- maximum percentage of total trip time as auto driver ----
	int       num_major_pnr;                 //---- maximum number of major park ride options --
	int       max_kissride;                  //---- maximum percentage of total trip time as auto passenger ----
	int       num_kissride;                  //---- maximum number of kiss ride options ----
	double    kissride_fac;                  //---- factor kiss-&-ride auto time to account for driver impedance ----
	double    drive_penalty;
	...
	bool      park_demand_flag;              //---- parking demand file flag ----
	...
	int       fare_class;                    //---- transit fare class ----

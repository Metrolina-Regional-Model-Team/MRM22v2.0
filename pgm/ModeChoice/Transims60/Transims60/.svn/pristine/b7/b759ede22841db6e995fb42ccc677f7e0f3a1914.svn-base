...
RiderSum::RiderSum (void) : Data_Service (), Select_Service ()
{
	...
	int select_service_keys [] = {
		SELECT_TRANSIT_MODES, SELECT_VEHICLE_TYPES, SELECT_TIME_OF_DAY, SELECT_START_TIMES, SELECT_END_TIMES, 
	...
	Control_Key ridersum_keys [] = {  //--- code, key, level, status, type, default, range, help ----
		...
		{ NEW_LOAD_SUMMARY_FILE, "NEW_LOAD_SUMMARY_FILE", LEVEL0, OPT_KEY, OUT_KEY, "", FILE_RANGE, NO_HELP },
		END_CONTROL
	};
	...
	stop_profile_flag = stop_vehtype_flag = stop_lines_flag = load_summary_flag = link_load_flag = false;
}
#ifdef _CONSOLE
//---------------------------------------------------------
//	main program

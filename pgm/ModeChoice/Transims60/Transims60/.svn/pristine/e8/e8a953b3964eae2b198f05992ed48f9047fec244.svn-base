...
public:
	...
	int    Return_Percent (void)           { return (return_percent); }
	int    Return_Purpose (void)           { return (return_purpose); }
	int    Return_Mode (void)              { return (return_mode); }
	double Scaling_Factor (void)           { return (scaling); }

	void   Group (int value)               { group = value; }
	void   Table (int value)               { table = value; }
	...
	void   Function (int value)            { function = value; }
	void   Return_Flag (bool flag)         { return_flag = flag; }
	void   Return_Percent (int value)      { return_percent = value; }
	void   Return_Purpose (int value)      { return_purpose = value; }
	void   Return_Mode (int value)         { return_mode = value; }
	...
	Db_Matrix * Trip_File (void)           { return (trip_file); }
	...
	void   Return_Period (Dtime tod);
	int    Return_Trips (int p)            { return (returns [p]); }

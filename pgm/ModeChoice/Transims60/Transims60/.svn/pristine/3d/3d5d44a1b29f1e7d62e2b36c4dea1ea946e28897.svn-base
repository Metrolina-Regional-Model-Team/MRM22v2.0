...
Router_Service::Router_Service (void) : Data_Service (), Flow_Time_Service ()
{
	...
	System_File_Type optional_files [] = {
		SHAPE, POCKET, LANE_USE, TURN_PENALTY, PARKING, ACCESS_LINK, VEHICLE_TYPE, 
		TRANSIT_STOP, TRANSIT_FARE, TRANSIT_ROUTE, TRANSIT_SCHEDULE, TRANSIT_DRIVER, 
		HOUSEHOLD, SELECTION, PERFORMANCE, TURN_DELAY, RIDERSHIP, PARK_DEMAND, 
		NEW_PLAN, NEW_PROBLEM, NEW_PERFORMANCE, NEW_PARK_DEMAND, NEW_PLAN_SKIM, END_FILE
	};
	...
	select_flag = update_flag = thread_flag = fare_class_flag = fare_list_flag = false;
	rider_flag = park_demand_flag = false;
...
void Router_Service::Router_Service_Keys (int *keys)
{
	Control_Key control_keys [] = { //--- code, key, level, status, type, default, range, help ----
		...
		{ CASH_FARE_PERCENTS, "CASH_FARE_PERCENTS", LEVEL1, OPT_KEY, LIST_KEY, "0", "0..100", NO_HELP },
		{ CARD_FARE_PERCENTS, "CARD_FARE_PERCENTS", LEVEL1, OPT_KEY, LIST_KEY, "0", "0..100", NO_HELP },
		{ SPECIAL_FARE_PERCENTS, "SPECIAL_FARE_PERCENTS", LEVEL1, OPT_KEY, LIST_KEY, "0", "0..100", NO_HELP },
		{ NUM_PARK_RIDE_OPTIONS, "NUM_PARK_RIDE_OPTIONS", LEVEL1, OPT_KEY, LIST_KEY, "10", "0..100", NO_HELP },
		{ MAX_PARK_RIDE_PERCENTS, "MAX_PARK_RIDE_PERCENTS", LEVEL1, OPT_KEY, LIST_KEY, "50 percent", "1..100 percent", NO_HELP },
		{ BUS_PARK_RIDE_OPTIONS, "BUS_PARK_RIDE_OPTIONS", LEVEL1, OPT_KEY, LIST_KEY, "0", "0..100", NO_HELP },
		{ BUS_PARK_RIDE_PERCENTS, "BUS_PARK_RIDE_PERCENTS", LEVEL1, OPT_KEY, LIST_KEY, "30 percent", "1..100 percent", NO_HELP },
		{ RAIL_PARK_RIDE_OPTIONS, "RAIL_PARK_RIDE_OPTIONS", LEVEL1, OPT_KEY, LIST_KEY, "0", "0..100", NO_HELP },
		{ RAIL_PARK_RIDE_PERCENTS, "RAIL_PARK_RIDE_PERCENTS", LEVEL1, OPT_KEY, LIST_KEY, "40 percent", "1..100 percent", NO_HELP },
		{ MAJOR_PARK_RIDE_OPTIONS, "MAJOR_PARK_RIDE_OPTIONS", LEVEL1, OPT_KEY, LIST_KEY, "0", "0..100", NO_HELP },
		{ MAJOR_PARK_RIDE_PERCENTS, "MAJOR_PARK_RIDE_PERCENTS", LEVEL1, OPT_KEY, LIST_KEY, "50 percent", "1..100 percent", NO_HELP },
		{ DRIVE_DISTANCE_PENALTIES, "DRIVE_DISTANCE_PENALTIES", LEVEL1, OPT_KEY, LIST_KEY, "0 impedance/foot", "0.0..1000.0", NO_HELP },
		{ NUM_KISS_RIDE_OPTIONS, "NUM_KISS_RIDE_OPTIONS", LEVEL1, OPT_KEY, LIST_KEY, "10", "1..100", NO_HELP },
		...
		{ FARE_CLASS_DISTRIBUTION, "FARE_CLASS_DISTRIBUTION", LEVEL0, OPT_KEY, LIST_KEY, "0", "CASH, CARD, SPECIAL", NO_HELP },
	...
	int file_service_keys [] = {
		NOTES_AND_NAME_FIELDS, SAVE_LANE_USE_FLOWS, TRIP_SORT_TYPE, PLAN_SORT_TYPE, 0
	};
	File_Service_Keys (file_service_keys);

	int data_service_keys [] = {
		DAILY_WRAP_FLAG, SUMMARY_TIME_RANGES, SUMMARY_TIME_INCREMENT, PARKING_DEMAND_TYPE, PARKING_PENALTY_FUNCTION, 0
	};

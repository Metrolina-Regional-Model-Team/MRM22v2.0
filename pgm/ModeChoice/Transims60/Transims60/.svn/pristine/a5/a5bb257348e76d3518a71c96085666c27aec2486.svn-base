...
LinkData::LinkData (void) : Data_Service ()
{
	...
	Control_Key keys [] = { //--- code, key, level, status, type, default, range, help ----
		...
		{ SUM_VOLUME_FLAG, "SUM_VOLUME_FLAG", LEVEL0, OPT_KEY, BOOL_KEY, "FALSE", BOOL_RANGE, NO_HELP },
		END_CONTROL
	};
	...
	link_node_flag = input_flag = node_map_flag = new_map_flag = new_link_node_flag = sum_vol_flag = false;

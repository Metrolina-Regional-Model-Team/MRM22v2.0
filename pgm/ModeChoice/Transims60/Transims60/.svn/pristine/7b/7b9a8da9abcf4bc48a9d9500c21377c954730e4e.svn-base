...
#define METERTOFEET     (3.28083333333333335958)   // US Survey Foot
...
enum Units_Type {       //---- data units types ----
	...
	CONNECT_CODE, PARKING_CODE, PARK_DEMAND_CODE, STOP_CODE, ID_CODE, CONTROL_CODE, SIGNAL_CODE, 
	MOVEMENT_CODE, DETECTOR_CODE, PROTECTION_CODE, TRANSIT_CODE, CLASS_CODE, FARE_ZONE_RANGE, 
...
enum System_File_Type {     //---- TRANSIMS standard file types ----
	...
	VEHICLE_TYPE, TRIP, PROBLEM, PLAN, SKIM, EVENT, TRAVELER, PARK_DEMAND, PLAN_SKIM,
	...
	NEW_VEHICLE_TYPE, NEW_TRIP, NEW_PROBLEM, NEW_PLAN, NEW_SKIM, NEW_EVENT, NEW_TRAVELER, NEW_PARK_DEMAND, NEW_PLAN_SKIM,
	END_FILE
};
...
enum Problem_Type {     //---- problem type options ----
	...
	TRANSFER_PROBLEM, LOCAL_PROBLEM, TRACE_PROBLEM, PARK_USE_PROBLEM, FUEL_PROBLEM, 
	PARK_CAP_PROBLEM, MAX_PROBLEM
};
...
enum Stop_Type {        //---- transit stop types ----
	NO_STOP, STOP, STATION, PNR_STOP, EXTLOAD, NEARSIDE, FARSIDE, MIDBLOCK, ON_ONLY, OFF_ONLY
};
enum Parking_Type {     //---- parking lot types ----
	STREET, LOT, BOUNDARY, PARKRIDE, BUS_PNR, RAIL_PNR, MAJOR_PNR
};
enum Park_Demand_Type {     //---- parking demand types ----
	ALL_LOTS, CAP_LOTS, PNR_LOTS, RAIL_LOTS
};

...
public:
	...
	Dtime  Penalty (void)             { return (penalty); }
	...
	void   Penalty (Dtime value)      { penalty = value; }
	...
	void   Clear (void)
	{
		schedule = time = penalty = 0; board = alight = load = factor = 0; off_rider = -1;
	}
private:
	Dtime  schedule;
	Dtime  time;
...
public:
	...
	double Ridership_Gap (bool capacity_flag = false, double factor = 0.0, bool zero_flag = true);
	void Update_Penalties (void) { Ridership_Gap (true, 0.0, false); }

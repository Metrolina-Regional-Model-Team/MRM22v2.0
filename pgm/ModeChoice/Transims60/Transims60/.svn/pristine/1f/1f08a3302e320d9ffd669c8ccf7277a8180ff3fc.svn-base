...
ConvertTrips::ConvertTrips (void) : Data_Service (), Select_Service ()
{
	...
	Control_Key converttrips_keys [] = { //--- code, key, level, status, type, default, range, help ----
		...
		{ TRIP_TABLE_NAME, "TRIP_TABLE_NAME", LEVEL1, OPT_KEY, TEXT_KEY, "", "", NO_HELP },
		...
		{ ACTIVITY_DURATION_FUNCTION, "ACTIVITY_DURATION_FUNCTION", LEVEL1, OPT_KEY, INT_KEY, "0", "0..100", NO_HELP },
		{ RETURN_TRIP_FLAG, "RETURN_TRIP_FLAG", LEVEL1, OPT_KEY, BOOL_KEY, "FALSE", BOOL_RANGE, NO_HELP },
		{ PERCENT_RETURN_TRIPS, "PERCENT_RETURN_TRIPS", LEVEL1, OPT_KEY, INT_KEY, "100", "0..100", NO_HELP },
		{ RETURN_TRIP_PURPOSE, "RETURN_TRIP_PURPOSE", LEVEL1, OPT_KEY, INT_KEY, "0", "0..100", NO_HELP },
		{ RETURN_TRIP_MODE, "RETURN_TRIP_MODE", LEVEL1, OPT_KEY, TEXT_KEY, "DRIVE", MODE_RANGE, NO_HELP },

...
protected:
	enum ConvertTrips_Keys { 
		...
		TRIP_TABLE_FILE, TRIP_TABLE_FORMAT, TRIP_TABLE_NAME, TRIP_SCALING_FACTOR, 
		TIME_DISTRIBUTION_FILE,	TIME_DISTRIBUTION_FORMAT, TIME_DISTRIBUTION_SCRIPT, 
		TIME_DISTRIBUTION_FIELD, TIME_DISTRIBUTION_TYPE, TIME_PERIOD_RANGE, 
		TIME_SCHEDULE_CONSTRAINT, ORIGIN_WEIGHT_FIELD, DESTINATION_WEIGHT_FIELD, 
		DISTANCE_WEIGHT_FLAG, STOP_WEIGHT_FIELD, TRAVELER_TYPE_SCRIPT, TRAVELER_TYPE_CODE, 
		TRIP_PURPOSE_CODE, TRAVEL_MODE_CODE, TRIP_PRIORITY_CODE, VEHICLE_TYPE_CODE, 
		AVERAGE_TRAVEL_SPEED, TRIP_STOP_DURATION, ACTIVITY_DURATION, ACTIVITY_DURATION_FUNCTION, 
		RETURN_TRIP_FLAG, PERCENT_RETURN_TRIPS, RETURN_TRIP_PURPOSE, RETURN_TRIP_MODE, 

...
public:
	...
	Dtime  Penalty (void)             { return (Get_Time (penalty)); }
	...
	void   Penalty (Dtime value)      { Put_Field (penalty, value); }
...
private:
	...
	int mode, route, run, stop, schedule, time, penalty, board, alight, load, factor;
};

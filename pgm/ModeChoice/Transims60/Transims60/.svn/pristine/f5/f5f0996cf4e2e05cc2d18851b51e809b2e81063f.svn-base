...
typedef vector <String_Pair>         String_Pairs;
typedef String_Pairs::iterator       String_Pair_Itr;
typedef String_Pairs::pointer        String_Pair_Ptr;
...
//---- an integer sorted array of keys ----

typedef map <int, Int2_Key>          Int_Key_Map;
typedef pair <int, Int2_Key>         Int_Key_Map_Data;
typedef Int_Key_Map::iterator        Int_Key_Map_Itr;
typedef pair <Int_Key_Map_Itr, bool> Int_Key_Map_Stat;
...
struct XY_Range {
	...
	XY_Range (void) : xmin(0), ymin(0), xmax(0), ymax(0) {}
};
...
typedef Vector <XY_Range>            XY_Ranges;
typedef XY_Ranges::iterator          XY_Range_Itr;
typedef XY_Ranges::reverse_iterator  XY_Range_RItr;
typedef XY_Ranges::pointer           XY_Range_Ptr;

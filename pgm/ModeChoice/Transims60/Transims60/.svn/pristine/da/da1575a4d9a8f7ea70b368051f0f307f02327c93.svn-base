...
private:
	enum projection_keys { INPUT_COORDINATE_SYSTEM = PROJECTION_OFFSET, 
		INPUT_COORDINATE_ADJUSTMENT, DATA_COORDINATE_SYSTEM, DATA_COORDINATE_ADJUSTMENT, 
		OUTPUT_COORDINATE_SYSTEM, OUTPUT_COORDINATE_ADJUSTMENT,
		OUTPUT_XYZ_SHAPES, OUTPUT_XYM_SHAPES };

	Projection_Data input, data, output;

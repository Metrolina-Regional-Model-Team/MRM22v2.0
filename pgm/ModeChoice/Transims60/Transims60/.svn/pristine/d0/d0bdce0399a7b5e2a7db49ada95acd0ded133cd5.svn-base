...
NewFormat::NewFormat (void) : Data_Service (), Select_Service ()
{
	...
	System_File_Type optional_files [] = {
		...
		VEHICLE_TYPE, TRIP, PROBLEM, PLAN, SKIM, PARK_DEMAND, PLAN_SKIM,
		...
		NEW_VEHICLE_TYPE, NEW_TRIP, NEW_PROBLEM, NEW_PLAN, NEW_SKIM, NEW_PARK_DEMAND, NEW_PLAN_SKIM, END_FILE
	};
	int file_service_keys[] = {
		NOTES_AND_NAME_FIELDS, SAVE_LANE_USE_FLOWS, SKIM_TOTAL_TIME_FLAG, TRIP_SORT_TYPE,
		TRANSIT_TIME_PERIODS, ROUTE_NODE_OFFSET_FLAG, ROUTE_NODE_RUN_TIME_FLAG, ROUTE_NODE_TYPE_FLAG, 0
	};
	int data_service_keys [] = {
		DAILY_WRAP_FLAG, SUMMARY_TIME_RANGES, SUMMARY_TIME_INCREMENT, 
		CONGESTED_TIME_RATIO, MAXIMUM_TIME_RATIO, PARKING_DEMAND_TYPE, PARKING_PENALTY_FUNCTION, 0
	};

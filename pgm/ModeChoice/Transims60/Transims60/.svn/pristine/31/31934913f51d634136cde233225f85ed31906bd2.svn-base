...
PlanSelect::PlanSelect (void) : Data_Service (), Select_Service ()
{
	...
	System_File_Type optional_files [] = {
		NODE, LINK, LANE_USE, CONNECTION, ACCESS_LINK, LOCATION, PARKING, TRANSIT_STOP, TRANSIT_ROUTE,
		VEHICLE_TYPE, PERFORMANCE, NEW_SELECTION, NEW_PLAN, END_FILE
	};
	...
	int select_service_keys [] = {
		...
		SELECT_STOPS, SELECT_ROUTES, SELECT_TRANSIT_MODES,

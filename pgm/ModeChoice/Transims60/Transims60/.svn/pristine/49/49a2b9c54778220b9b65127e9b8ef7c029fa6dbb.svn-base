...
protected:
	enum PlanSum_Keys { NEW_TRIP_TIME_FILE = 1, NEW_LINK_VOLUME_FILE, NEW_ACCESS_DETAIL_FILE, 
		...
		NEW_STOP_TRANSFER_FILE, NEW_STOP_TRANSFER_FORMAT, NEW_PLAN_SKIM_FILE, NEW_PLAN_SKIM_FORMAT, 
		NEW_PLAN_STOP_FILE, NEW_PLAN_STOP_FORMAT,
	};
...
private:
	...
	bool access_group_flag, plan_skim_flag, stop_transfer_flag, plan_stop_flag;
	...
	Db_Header transfer_file, plan_stop_file;

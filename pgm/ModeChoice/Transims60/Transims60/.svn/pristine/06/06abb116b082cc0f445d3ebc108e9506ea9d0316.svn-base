...
public:
	...
	Park_Demand_Array   park_demand_array;
	Plan_Skim_Array     plan_skim_array;
	...
	bool Fare_Flag(void)                { return (fare_flag); }
	...
	bool Transit_Connections (void)      { return (transit_connect_flag); }
	void Transit_Connections (bool flag) { transit_connect_flag = flag; }
	...
	virtual void Write_Park_Demand (void);
	virtual void Write_Plan_Skims (void);
	...
	virtual int Put_Park_Demand_Data (Park_Demand_File &file, Parking_Demand_Data &data, int function = 0);
	virtual int Put_Plan_Skim_Data (Plan_Skim_File &file, Plan_Skim_Data &data);
	...
	enum Data_Service_Keys { 
		...
		HIGHEST_ZONE_NUMBER, UPDATE_LINK_BEARINGS, LINK_BEARING_WARNINGS,
		ROUTE_MODE_MAP, MODE_VEH_TYPE_MAP, PARKING_DEMAND_TYPE, PARKING_PENALTY_FUNCTION, 
	};
...
protected:
	...
	virtual bool Get_Park_Demand_Data (Park_Demand_File &file, Parking_Demand_Data &data, int function = 0);
	virtual bool Get_Plan_Skim_Data (Plan_Skim_File &file, Plan_Skim_Data &data);
	...
	virtual void Initialize_Park_Demand (Park_Demand_File &file);
	virtual void Initialize_Plan_Skims (Plan_Skim_File &file);
	...
	virtual void Read_Park_Demand (Park_Demand_File &file);
	virtual void Read_Plan_Skims (Plan_Skim_File &file);
...
private:
	...
	bool ratio_flag, loc_xy_flag, sum_flow_flag, clear_flow_flag, time_table_flag, transit_veh_flag, fare_flag;
	bool person_map_flag, lane_use_flows, update_bearings, bearing_warnings, transit_connect_flag;

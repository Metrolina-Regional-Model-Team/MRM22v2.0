Macro "Tour_TOD2_Night_TRMG2" (Args)
...
//________OD tables:  Add EE vehicles and COM/TRUCK cores
	...
	odhtk = CreateMatrixCurrency(OD, "HTK", "Rows", "Columns",)
        ...
        MatrixOperations(odcom, {c1,c2,c3,c4,tc}, {0.1655,0.1965,0.1965,0.331,0.1655},,, {{"Operation", "Add"}, {"Force Missing", "No"}})
        MatrixOperations(odmtk, {m1,m2,m3,m4,tm}, {0.1655,0.1965,0.1965,0.331,0.1655},,, {{"Operation", "Add"}, {"Force Missing", "No"}})
        MatrixOperations(odhtk, {h1,h2,h3,h4,th}, {0.1655,0.1965,0.1965,0.331,0.1655},,, {{"Operation", "Add"}, {"Force Missing", "No"}})
